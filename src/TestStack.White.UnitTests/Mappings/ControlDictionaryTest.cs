...
namespace TestStack.White.UnitTests.Mappings
{
    public class ControlDictionaryTest
    {
        ...
        public void GetTestControlType()
        {
            ...
            Assert.Equal(typeof(Win32ListItem), controlDictionary.GetTestControlType(string.Empty, string.Empty, ControlType.ListItem, WindowsFramework.Wpf.FrameworkId(), false));
        }
